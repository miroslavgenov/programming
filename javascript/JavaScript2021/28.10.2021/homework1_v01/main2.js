...
// от филтрирания резултат на people
var studendsOnly = people.filter((st) => st instanceof Student);
// този масив lecturersOnly ще съхранява преподаватели
// от филтрирания резултат на people
var lecturersOnly = people.filter((lect) => lect instanceof Student);
...
studendsOnly.forEach((st) => st.Show());
...
lecturersOnly.forEach((lect) => lect.Show());
