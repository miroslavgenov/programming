...
class Router{
    ...
    private $routes;
    #
    private const myUri = "http://localhost/";

    public function __construct(){
        $this->routes = require_once(PATH.'\\configs\\routes.php');
        
        foreach($this->routes as $idx=>$el){
            echo "<b><p>".self::myUri.$idx."</p></b>";
        }

        echo "<ul>
          <li><a href='/miroslav_331_project_correct/list/all'>Списък на всички програмни езици</a></li>
          <li><a href='/miroslav_331_project_correct/year/1990'>Програмни езици, създадени след определена година</a></li>
          <li><a href='/miroslav_331_project_correct/inforate/5'>Топ N програмни езици</a></li>
          <li><a href='/miroslav_331_project_correct/добави'>Добавя програмен език</a></li>
        </ul>";
